...
relationships:
  - type: enforces
    target: RULE-006
    rationale: "Codifies lint suppression governance referenced in coding standards"
  - type: enforces
    target: RULE-043
    rationale: "Extends tooling ecosystem delegation to cover suppression annotations"
  - target: IDEA-087
    type: informed-by
