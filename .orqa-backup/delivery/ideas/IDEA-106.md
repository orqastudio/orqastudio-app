...
relationships:
  - type: informed-by
    target: PILLAR-001
    rationale: Sections make the project's structured thinking visible through different lenses
  - type: informed-by
    target: AD-051
    rationale: Three-layer artifact model determines what appears in each section
  - type: informed-by
    target: AD-052
    rationale: Relationship vocabulary determines the graph queries that power each section
---
