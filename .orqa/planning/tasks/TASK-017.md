...
description: >
  Implements an onboarding wizard for first-time users covering Claude CLI detection,
  auth verification, and project name, icon, and model configuration.
status: done
epic: EPIC-035
created: 2026-03-04
updated: 2026-03-09
...
acceptance:
  ...
  - Project name, icon, model configuration
  - Custom project icon upload/removal
tags: [onboarding, setup-wizard, settings]
---
