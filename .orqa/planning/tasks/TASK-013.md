...
description: >
  Implements the code indexing pipeline using DuckDB to store file chunks,
  and exposes a regex search command for matching patterns across all indexed content.
status: done
epic: EPIC-034
created: 2026-03-04
updated: 2026-03-09
...
acceptance:
  - DuckDB database stores code chunks with file path, content, and metadata
  - Regex search finds patterns across indexed files
  - IPC command registered and callable from frontend
tags: [search, duckdb, regex, indexing]
---
