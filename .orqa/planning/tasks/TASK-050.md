...
description: >
  Updates the artifact framework documentation to formally define the three-layer
  classification model and agent scope categories, and updates the skill enforcement
  rule to reference layer-aware loading decisions.
status: done
epic: EPIC-044
created: 2026-03-09
updated: 2026-03-09
...
tags: [governance, documentation, classification, schema]
---
