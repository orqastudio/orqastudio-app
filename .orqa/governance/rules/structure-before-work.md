...
- `documentation-first.md` — documentation before code (this rule extends it to ALL artifacts)
- `artifact-lifecycle.md` — artifact creation standards and status transitions
- `enforcement-before-code.md` — enforcement artifacts before implementation
- `no-deferred-deliverables.md` — if it's in scope, it ships
- `honest-reporting.md` — structure prevents ambiguous completion claims
