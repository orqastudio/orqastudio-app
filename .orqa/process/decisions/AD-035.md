...
relationships:
  ...
  - type: informed-by
    target: AD-034
    rationale: Schema-driven filtering provides the field options that navigation defaults configure with initial values
  - type: informed-by
    target: AD-037
    rationale: AI search complements configured defaults by offering intent-based discovery when structured browsing isn't sufficient
  - target: "RULE-003"
    type: "enforced-by"
